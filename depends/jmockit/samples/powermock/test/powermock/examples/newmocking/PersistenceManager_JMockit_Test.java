...
public final class PersistenceManager_JMockit_Test
{
   ...
   @Test
   public void testCreateDirectoryStructure_usingRegularStrictMocking(@Mocked final File fileMock)
   {
      final String path = "directoryPath";
   ...
   public void testCreateDirectoryStructure_fails(@Mocked final File fileMock)
   {
