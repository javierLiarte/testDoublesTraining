...
public final class AbstractXMLRequestCreatorBase_JMockit_Test
{
   ...
   public void testCreateRequest(
      @Mocked DocumentHelper unused, @Mocked final Document documentMock, @Mocked final Element rootElementMock,
      @Mocked final Element headerElementMock, @Mocked final Element bodyElementMock) throws Exception
   {
