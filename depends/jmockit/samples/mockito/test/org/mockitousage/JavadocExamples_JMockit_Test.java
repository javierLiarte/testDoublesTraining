...
public final class JavadocExamples_JMockit_Test
{
   ...
   @Test // Uses of JMockit API: 4
   public void validatingArgumentWithCustomArgumentMatcher(@Mocked final MockedClass mock)
   {
      mock.doSomething(new Person("John"));
      mock.doSomething(new Person("Jane"));
   ...
   @Test // Uses of JMockit API: 7
   public void validatingArgumentForEachInvocation(@Mocked final MockedClass mock)
   {
      mock.doSomething(new Person("John"));
      mock.doSomething(new Person("Jane"));
   ...
   @Test // Uses of JMockit API: 5
   public void validatingArgumentsForEachInvocation(@Mocked final MockedClass mock)
   {
      mock.doSomething("test", true);
