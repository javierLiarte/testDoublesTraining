...
public final class AnimationManagerTest
{
   ...
   @Test
   public void resetWhenNotEmpty(@Mocked("") JComponent container, @Mocked("cleanup")
         final AnimationState animationState)
   {
      final AnimationManager manager = new AnimationManager(container);

      new Expectations() {{
         new AnimationState(new JButton(), true);
   ...
   public void addStartStateForComponent(
      @Mocked final AnimationState animationState, @Mocked ComponentState componentState)
   {
      ...
      new Expectations() {{
         new AnimationState(component, true);   // first addStart
      ...
      @Mocked final AnimationState animationState, @Mocked ComponentState componentState)
   {
      ...
      new Expectations() {{
         new AnimationState(component, false); // first addEnd
   ...
   public void setupEndForComponentWithSameStartAndEndStates(
      @Mocked("(ComponentState, boolean)") final AnimationState startState)
   {
      final JButton component = new JButton();
      JComponent container = new JPanel();
      container.add(component);
   ...
   @Test
   public void paint(@Mocked final Graphics g, @Mocked final AnimationState animationState)
   {
      JComponent container = new JPanel();
