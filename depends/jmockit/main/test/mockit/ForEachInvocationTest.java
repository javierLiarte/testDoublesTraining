...
public final class ForEachInvocationTest
{
   ...
   @Test
   public void recordExpectationsWithHandlersForEachInvocation(@Mocked final Collaborator mock)
   {
   ...
   @Test
   public void recordExpectationWithHandlerForEachInvocationOfConstructor(@Mocked Collaborator mock)
   {
   ...
   @Test(expected = AssertionError.class)
   public void recordExpectationWithHandlerForStaticMethodWhichAlsoReturnsAValue(@Mocked Collaborator unused)
   {
      new Expectations() {{
   ...
   @Test
   public void recordExpectationWithInvocationHandlerWhichDefinesStaticHandlerMethod(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {{
